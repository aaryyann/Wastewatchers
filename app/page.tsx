    ...
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      <section className="text-center mb-20">
        ...
        <h1 className="text-4xl font-bold mb-6 text-gray-800 tracking-tight">
          Waste-To-Wonder <span className="text-green-600">: A Heroic Journey in Waste Management</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
        Be a part of our mission to make waste management more efficient and rewarding!
        </p>
        {!loggedIn ? (
      ...
      <section className="grid md:grid-cols-3 gap-10 mb-20">
        <FeatureCard
          icon={Leaf}
          title="Enoviroment-Friendly"
          description="Join the effort to protect our environment by identifying and removing litter"
        />
        <FeatureCard
          icon={Coins}
          title="Earn Rewards"
          description="Get recognized with tokens for your waste management contributions."
        />
        <FeatureCard
          icon={Users}
          title="Community-Driven"
          description="Engage with a community passionate about sustainable living."
        />
      </section>
